--[[
    ...
    🐺 LXR Core - Weather Sync System | CLIENT
...
RegisterNetEvent('LXRCore:Client:OnPlayerLoaded', function()
    disable = false
    TriggerServerEvent('lxr-weathersync:server:RequestStateSync')
    TriggerServerEvent('lxr-weathersync:server:RequestCommands')
end)

RegisterNetEvent('lxr-weathersync:client:EnableSync', function()
    disable = false
    TriggerServerEvent('lxr-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('lxr-weathersync:client:DisableSync', function()
	disable = true
...
RegisterNetEvent('lxr-weathersync:client:SyncWeather', function(NewWeather, newblackout)
    CurrentWeather = NewWeather
    blackout = newblackout
end)

RegisterNetEvent('lxr-weathersync:client:RequestCommands', function(isAllowed)
    if isAllowed then
...
RegisterNetEvent('lxr-weathersync:client:SyncTime', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
